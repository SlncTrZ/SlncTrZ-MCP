/**
 * Atomic Filesystem Write — apply-by-default UTF-8 writes with explicit preview and optimistic concurrency.
...
export const DEFAULT_MAX_WRITE_BYTES = 8 * 1_048_576;
...
/** Apply an atomic write by default; use `dryRun: true` for a non-mutating preview. */
