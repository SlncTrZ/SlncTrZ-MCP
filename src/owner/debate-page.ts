...
<style>
:root{color-scheme:light dark;--bg:#eef0f3;--surface:#fbfcfd;--surface2:#f4f6f8;--surface3:#e9edf2;--text:#1a1d21;--muted:#697586;--line:#dfe3e8;--line-strong:#c7ced8;--accent:#2f5a9e;--accent-soft:#eaf0fa;--violet:#7255a8;--good:#18794e;--warn:#a15c08;--bad:#a52838;--focus:#2563eb}
...
.workspace{display:grid;grid-template-columns:minmax(15rem,19rem) minmax(0,1fr);min-height:36rem;background:var(--surface);border:1px solid var(--line);border-radius:14px;overflow:hidden;box-shadow:0 1px 2px rgba(16,24,40,.04)}
...
@media(prefers-color-scheme:dark){:root{--bg:#0f1115;--surface:#171a20;--surface2:#20242c;--surface3:#292f38;--text:#e6e8eb;--muted:#9aa4b2;--line:#2c323b;--line-strong:#46505e;--accent:#6b9af4;--accent-soft:#1d2940;--violet:#a78bfa;--good:#6ee7b7;--warn:#f0b15d;--bad:#fb7185;--focus:#7da7ff}.workspace{box-shadow:none}.error{background:#35171e;border-color:#71303d;color:#f2a7b5}}
